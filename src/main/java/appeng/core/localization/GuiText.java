...
public enum GuiText implements LocalizationEnum {
    ...
    SearchSettingsReverseFilterFunction("Reverse the function of # and $ in search filter"),
    ...
    SearchTooltipToolTips("Use %s to search in tooltips (%slooting)"),
    SearchTooltipItemId("Use * to search by id (*cell)"),
    SearchTooltipTag("Use %s to search by tags (%singot)"),
